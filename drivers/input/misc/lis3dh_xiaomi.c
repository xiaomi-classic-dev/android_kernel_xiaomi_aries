...
#ifdef CONFIG_SENSORS_LIS3DH_XIAOMi_EARLYSUSPEND
...
#if defined(CONFIG_PM) || defined(CONFIG_SENSORS_LIS3DH_XIAOMi_EARLYSUSPEND)
...
#ifndef CONFIG_SENSORS_LIS3DH_XIAOMi_EARLYSUSPEND
